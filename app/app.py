...
<style>
    ...
    .stApp { font-family: 'Poppins', sans-serif; background: linear-gradient(135deg, #e8f5e8 0%, #dcf5dc 50%, #f0fdf4 100%); }
    .eco-header { background: linear-gradient(135deg, #059669 0%, #10b981 50%, #22c55e 100%); color: white; padding: 30px; border-radius: 20px; text-align: center; margin-bottom: 30px; box-shadow: 0 10px 30px rgba(5,150,105,0.3); }
    .eco-header h1 { font-size: 2.2rem; margin-bottom: 6px; }
    .form-container { background: rgba(255,255,255,0.95); border-radius: 20px; border: 2px solid rgba(34,197,94,0.12); padding: 20px; }
    .section-header { background: linear-gradient(135deg, #059669 0%, #22c55e 100%); color: white; padding: 10px 12px; border-radius: 12px; margin: 14px 0; text-align: center; font-weight: 600; }
    .results-container { background: linear-gradient(135deg,#e8f5e8,#f1f8e9); border-radius: 12px; padding: 18px; margin-top: 18px; }
    .stButton>button { background: linear-gradient(45deg,#4caf50,#66bb6a); color: white; border-radius: 50px; padding: 12px 20px; font-weight:600; border: none; }
    .stButton>button:hover { transform: translateY(-2px); box-shadow: 0 5px 15px rgba(76,175,80,0.3); }
    .reset-button button { background: linear-gradient(45deg,#f39c12,#e67e22) !important; color: white !important; border-radius: 50px !important; padding: 8px 16px !important; font-weight:500 !important; }
    .success-banner { background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; padding: 15px; border-radius: 12px; text-align: center; margin: 20px 0; animation: fadeIn 0.5s; }
...
# Footer
st.markdown("""
<div style='text-align:center; margin-top:24px; padding: 20px; background: rgba(255,255,255,0.7); border-radius: 12px;'>
    <strong>🤖 Powered by Machine Learning & Environmental Science</strong><br>
    <small>🌍 Every prediction helps build a more sustainable future 🌱</small><br>
    <small style='color: #666;'>Made with ❤️ for a greener planet</small>
</div>
""", unsafe_allow_html=True)